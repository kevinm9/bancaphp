  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-dashboard"></i> <span>Consolidada de saldos</span></a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i> <span>Historial de movimientos</span></a></li>
        <li><a href="#"><i class="fa fa-dashboard"></i> <span>Transferencia bancaria</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
